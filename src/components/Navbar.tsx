      ...
      <div className={cn(
        ...
        <nav className={cn(
          ...
          {[
            ...
            <a
              ...
              href={link.href}
              className={cn(
                "text-[11px] font-black transition-all duration-200 px-3 py-1.5 rounded-full whitespace-nowrap",
                isScrolled 
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          >
            ...
            />
            <span className="relative z-10 whitespace-nowrap">Audit Miễn Phí</span>
          </motion.button>
        </div>
